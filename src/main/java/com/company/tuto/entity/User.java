...
@JmixEntity
@Entity(name = "UU1_User")
@Table(name = "UU1_USER", indexes = {
        @Index(name = "IDX_UU1_USER_ON_USERNAME", columnList = "USERNAME", unique = true),
        @Index(name = "IDX_UU1_USER_DEPARTMENT", columnList = "DEPARTMENT_ID")
})
